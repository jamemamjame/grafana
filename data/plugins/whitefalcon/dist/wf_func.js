System.register(['lodash', './func_instance'], function(exports_1) {
    var lodash_1, func_instance_1;
    var WfFunc;
    return {
        setters:[
            function (lodash_1_1) {
            ...
            function (func_instance_1_1) {
                func_instance_1 = func_instance_1_1;
            }],
        execute: function() {
            WfFunc = (function () {
                function WfFunc() {
                    ...
                    this.SERIES_IDS = ["A", "B", "C", "D", "E", "F", "G", "H", "I",
                ...
                WfFunc.prototype.addFuncDef = function (funcDef) {
                ...
                WfFunc.prototype.createFuncInstance = function (funcDef, options) {
                    if (lodash_1.default.isString(funcDef)) {
                        if (!this.index[funcDef]) {
                            throw { message: 'Method not found ' + name };
                        }
                        funcDef = this.index[funcDef];
                    }
                    return new func_instance_1.default(funcDef, options, this);
                };
                WfFunc.prototype.getFuncDef = function (name) {
                    return this.index[name];
                };
                WfFunc.prototype.getCategories = function () {
                    return this.categories;
                };
                return WfFunc;
            })();
            exports_1("default",WfFunc);
        }
    }
});
//# sourceMappingURL=wf_func.js.map